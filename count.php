...
<html>
	...
	<body>
		<div class="container">
			<h2 class="text-center mt-4 mb-3">NOC LITUP</a></h2>

			<!--<div class="card">
				<div class="card-header"> Survey</div>
				<div class="card-body">
					<div class="form-group">
						<h2 class="mb-4">Total LITUP till 2022?</h2>
						<div class="form-check">
							...
							<label class="form-check-label mb-2" for="programming_language_1">Package A</label>
						</div>
						<div class="form-check">
							<input type="radio" name="programming_language" id="programming_language_2" class="form-check-input" value="Node.js">
							<label class="form-check-label mb-2" for="programming_language_2">Package B</label>
						</div>
						<div class="form-check">
							...
							<label class="form-check-label mb-3" for="programming_language_3">Package C</label>
						</div>
					</div>
					<div class="form-group">
...
$(document).ready(function(){
	...
	$('#submit_data').click(function(){
		...
		$.ajax({
			url:"data.php",
			method:"POST",
			data:{action:'insert', package:package},
			beforeSend:function()
			{
	...
	function makechart()
	{
		$.ajax({
			...
			success:function(data)
			{
				...
				{
					package.push(data[count].package);
...
$con = mysqli_connect("localhost","root","","test_db");
	...
	//$sql = "SELECT COUNT(*) FROM lit_up_data WHERE package = 'A';"
	$sql = "SELECT COUNT * FROM lit_up_data WHERE package = A;
