...
<head>
	<meta charset="UTF-8">
	<title>Escalation Matrx (Pack-B) Details</title>
...
<body>
	<section>
		<h1>Escalation Matrix (Pack-B)</h1>
		<!-- TABLE CONSTRUCTION-->
		<table>
			<tr>
				<th>District</th>
        ...
        <?php // LOOP TILL END OF DATA
			...
			<tr>
				...
				<td><?php echo $rows['Field Engineer'];?></td>
				<td><?php echo $rows['Contact No'];?></td>
				<td><?php echo $rows['Email ID'];?></td>
				<td><?php echo $rows['District Lead'];?></td>
				<td><?php echo $rows['Contact_No'];?></td>
				<td><?php echo $rows['Email_ID'];?></td>
				<td><?php echo $rows['Zonal Lead'];?></td>
				<td><?php echo $rows['Contact__No'];?></td>
				<td><?php echo $rows['Email__ID'];?></td>
			</tr>
			<?php
