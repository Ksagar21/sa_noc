...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2021 at 12:50 PM
...
CREATE TABLE `lit_up_data` (
  ...
  `system_loc` varchar(1000) NOT NULL,
  `device` varchar(1000) NOT NULL,
  `reg` varchar(1000) NOT NULL,
  `last_discovered` varchar(1000) NOT NULL,
  `snmp` varchar(1000) NOT NULL,
  `span` varchar(1000) NOT NULL,
  `at` varchar(1000) NOT NULL,
  `csc` varchar(1000) NOT NULL,
  `privilege` varchar(1000) NOT NULL,
  `lit_up` varchar(1000) NOT NULL,
  `noc_engineer` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lit_up_data` (`id`, `package`, `district`, `taluka`, `gp_name`, `ip_address`, `status`, `system_loc`, `device`, `reg`, `last_discovered`, `snmp`, `span`, `at`, `csc`, `privilege`, `lit_up`, `noc_engineer`) VALUES
('09/09/2021', 'C', 'Ahmednagar', ' Shrirampur', 'khandala', '172.31.131.200', 'Active', 'Cisco', 'Cisco', '12', '12', '12', 'ahshr0147', 'test', ' test', 'yes', ' seq', 'Vishal'),
('08/09/2021', '123', 'test456', ' 753', '952', '852', '8546', '7139', '9658', '278', '8232', '32548', '364', '1745', ' 9425', '3412', ' 788', 'sds');
